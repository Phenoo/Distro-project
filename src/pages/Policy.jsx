    ...
    <div className="policy">
      ...
      <h1 className="headline">
        ...
        <p>
          ...
          This Privacy Policy applies to our website, distro.com.ng , and its associated subdomains (collectively, our "Service") alongside our application, Distro Logistics. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
        </p>
        <div className="article">
          ...
          <ul>
            ...
            <li>
              ...
              <p>
              where Distro Logistics or the owners/founders of Distro Logistics are based, in this case is Nigeria
              </p>
            </li>
            <li>
              <h5>
              ...
              <p>
                refers to the company, organization or person that signs up to use the Distro Logistics Service to manage the relationships with your consumers or service users.
              </p>
            </li>
            <li>
              <h5>
              ...
              <p>
              any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Distro App and use the services.
              </p>
            </li>
            <li>
              <h5>
            ...
            <li>
              ...
              <p>
              refers to those individuals who are employed by Distro Logistics or are under contract to perform a service on behalf of one of the parties.
              </p>
            </li>
            <li>
              <h5>personal data</h5>
            ...
            <li>
              ...
              <p>
              refers to the service provided by Distro Logistics as described in the relative terms (if available) and on this platform.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                Distro Logistics’s site, which can be accessed via this URL: distro.com.ng.
            ...
            <li>
              ...
              <p>
                a person or entity that is registered with Distro Logistics to use the Services.
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="article">
          ...
          <p>
            We are committed to helping our customers meet the data subject rights requirements of GDPR. Distro Logistics processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all conversation and personal data for up to 6 years unless your account is deleted. In which case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.
